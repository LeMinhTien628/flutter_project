        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rankings_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CrustRating = table.Column<byte>(type: "tinyint", nullable: false),
                    SauceRating = table.Column<byte>(type: "tinyint", nullable: false),
                    CheeseRating = table.Column<byte>(type: "tinyint", nullable: false),
                    ToppingRating = table.Column<byte>(type: "tinyint", nullable: false),
                    OverallTasteRating = table.Column<byte>(type: "tinyint", nullable: false),
                    PresentationRating = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrustType = table.Column<string>(type: "nvarchar(max)", nullable: true),
